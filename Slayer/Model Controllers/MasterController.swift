...
class MasterController {
    ...
    static var masters: [Master] {
        let duradel = Master(name: "Duradel", image: #imageLiteral(resourceName: "final duradel"), examine: "He looks dangerous!", chatHead: #imageLiteral(resourceName: "duradel"), reqs: #imageLiteral(resourceName: "durareqs"), points: #imageLiteral(resourceName: "duradelpoints"), location: #imageLiteral(resourceName: "duradellocation"), weights: #imageLiteral(resourceName: "duracolumn"))
        let nieve = Master(name: "Nieve", image: #imageLiteral(resourceName: "finalnieve"), examine: "She looks rich and dangerous!", chatHead: #imageLiteral(resourceName: "nieve"), reqs: #imageLiteral(resourceName: "nievereqs"), points: #imageLiteral(resourceName: "nievepoints"), location: #imageLiteral(resourceName: "nievelocation"), weights: #imageLiteral(resourceName: "newnieveweight"))
        let chaeldar = Master(name: "Chaeldar", image: #imageLiteral(resourceName: "finalchaeldar"), examine: "She looks dangerous!", chatHead: #imageLiteral(resourceName: "chaeldar"), reqs: #imageLiteral(resourceName: "chaeldarreqs"), points: #imageLiteral(resourceName: "chaeldarpoints"), location: #imageLiteral(resourceName: "chaeldarlocation"), weights: #imageLiteral(resourceName: "newchaelweight"))
